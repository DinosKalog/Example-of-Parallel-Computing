...
int main(int argc, char *argv[]) {
	...
	int threads = omp_get_num_threads();//Save number of threads
	#pragma omp master//Only the master thread will...
	printf("[Rank %d] Number of threads is: %d \n",rank,threads);//...print number of threads
